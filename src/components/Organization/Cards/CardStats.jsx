...
//               <div className="mt-2" style={{ marginLeft: '-2.4rem' }}>
...
//             <div
//               className={`text-white p-3 text-center inline-flex items-center justify-center w-12 h-12 shadow-lg rounded-full ${statIconColor} transition-all duration-200 hover:scale-105 cursor-pointer`}
//             >
